...
import { ArrowRight, Wallet, Users, Zap, ShieldCheck, Smartphone } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="glass fixed top-0 w-full z-50 border-b border-white/20">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link
            href="/auth"
            className="bg-primary text-white px-6 py-2 rounded-full font-medium hover:bg-primary/90 transition-all card-shadow"
          >
            Login
          </Link>
        </div>

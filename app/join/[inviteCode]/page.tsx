...
export default function JoinGroupPage() {
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center gap-6 p-6 bg-slate-50 dark:bg-slate-950">
    ...
    if (error) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-8 text-center space-y-8 relative overflow-hidden bg-slate-50 dark:bg-slate-950">
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-3 md:p-6 relative overflow-hidden bg-slate-50 dark:bg-slate-950">
            {/* Ambient Background */}
            ...
            <div className="w-full max-w-md bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl rounded-[3rem] md:rounded-[3.5rem] p-8 md:p-14 card-shadow border border-white dark:border-slate-800 text-center space-y-10 relative z-10 animate-in fade-in zoom-in duration-700 mx-1">
                ...
                {isLoggedIn === false ? (
                    ...
                    <button
                        onClick={handleJoin}
                        disabled={joining}
                        className="w-full bg-primary text-white py-6 rounded-[2.5rem] font-black text-xl hover:bg-primary/90 transition-all card-shadow disabled:opacity-50 flex items-center justify-center gap-4 shadow-xl shadow-primary/30 active:scale-95 px-2"
                    >
